...
<head>
	<meta charset="UTF-8">
	<title>NooN xs</title>
	<link rel="stylesheet" href="/01_gustavo/resources/css/font-awesome/css/font-awesome.min.css" />
	<link rel="stylesheet" href="/01_gustavo/resources/css/bootstrap/bootstrap.min.css" />
	<link rel="stylesheet" href="/01_gustavo/resources/css/linearicons.css" />
	<link rel="stylesheet" href="/01_gustavo/resources/css/iconmoon.css" />
	<link rel="stylesheet" href="/01_gustavo/resources/css/animat/animate.min.css" />
	<link rel="stylesheet" href="/01_gustavo/resources/css/fancybox/jquery.fancybox.css" />
	<link rel="stylesheet" href="/01_gustavo/resources/css/nivo-lightbox/nivo-lightbox.css" />
	<link rel="stylesheet" href="/01_gustavo/resources/css/themes/default/default.css" />
	<link rel="stylesheet" href="/01_gustavo/resources/css/owl-carousel/owl.carousel.css" />
	<link rel="stylesheet" href="/01_gustavo/resources/css/owl-carousel/owl.theme.css" />
	<link rel="stylesheet" href="/01_gustavo/resources/css/owl-carousel/owl.transitions.css">
	
	<link rel="stylesheet" href="/01_gustavo/resources/css/style.css" />
	<link rel="stylesheet" href="/01_gustavo/resources/css/responsive.css" />
</head>
<body>
						...
						<div class="navbar-header">
						  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
							...
							<a class="navbar-brand" href="#home">
								<div class="logo">
									<img src="/01_gustavo/resources/images/logo.png" alt="" />
								</div>
							</a>
						</div>
				...
				<div class="main_banner_area">
					<div class="col-md-6 col-sm-6">
						<div class="single_banner wow fadeIn">
							<img src="/01_gustavo/resources/images/iphone1.png" alt="" />
						</div>
					</div>
					<div class="col-md-6 col-sm-6">
						<div class="single_banner_text wow zoomIn" data-wow-duration="1s">
							...
							<div class="apps_downlod">
								<a href=""><img src="/01_gustavo/resources/images/ap.png" alt="" /></a>
								
								<a href=""><img src="/01_gustavo/resources/images/ag.png" alt="" /></a>
							</div>
						</div>
					</div>
				...
				<div class="abouts_content">
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="single_abouts_img text-center wow fadeInLeft" data-wow-duration="1s">
							<img src="/01_gustavo/resources/images/abouts.png" alt="" />
						</div>
					</div>
				...
				<div class="main_features">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="single_features_img wow fadeIn" data-wow-duration="2s">
							<img src="/01_gustavo/resources/images/features.png" alt="" />
						</div>
					</div>
				</div>
			</div>
				...
				<div class="main_works">
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="single_works_text_middel text-center wow fadeInDown" data-wow-duration="2s">
							<img src="/01_gustavo/resources/images/workiphone.png" alt="" />
						</div>
					</div>
			...
			<div class="row">
				<div class="main_video_content text-center">
					...
					<div class="col-md-12 col-sm-12">
						<div class="icon_area">
							<a href="http://youtube.com" class="youtube-media"><img src="/01_gustavo/resources/images/play.png" alt="play-icon" /></a>
						</div>
					</div>
							...
							<div class="single_clients">
								...
								<div class="clients_details">
									<div class="clients_img">
										<img src="/01_gustavo/resources/images/clients.png" alt="" />
									</div>
	...
	<script type="text/javascript" src="/01_gustavo/resources/js/jquery/jquery.js"></script>
	<script type="text/javascript" src="/01_gustavo/resources/js/script.js"></script>
	<script type="text/javascript" src="/01_gustavo/resources/js/bootstrap/bootstrap.min.js"></script>
	<script type="text/javascript" src="/01_gustavo/resources/js/fancybox/jquery.fancybox.pack.js"></script>
	<script type="text/javascript" src="/01_gustavo/resources/js/nivo-lightbox/nivo-lightbox.min.js"></script>
	<script type="text/javascript" src="/01_gustavo/resources/js/owl-carousel/owl.carousel.min.js"></script>
	<script type="text/javascript" src="/01_gustavo/resources/js/jquery-easing/jquery.easing.1.3.js"></script>
	<script type="text/javascript" src="/01_gustavo/resources/js/wow/wow.min.js"></script>
</body>
</html>